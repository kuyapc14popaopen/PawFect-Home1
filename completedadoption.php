...
<?php
$query = "SELECT adoption_success.ad_id, adoption_success.name, adoption_success.pet_name, adoption_success.pet_category, adoption_success.breed, adoption_success.color, adoption_success.gender, adoption_success.age, adoption_success.age_type, adoption_success.size, adoption_success.vaccinated, adoption_success.neutured, adoption_success.weight, adoption_success.city_village, adoption_success.district, adoption_success.state, adoption_success.description, adoption_success.about_pet, adoption_success.adoption_rules, adoption_success.available, adoption_success.image_url
          FROM adoption_success
          LEFT JOIN confirmed_ad_images ON adoption_success.ad_id = confirmed_ad_images.ad_id";
