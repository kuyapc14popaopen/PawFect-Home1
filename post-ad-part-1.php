                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="details_category">
                             ...
                             <div class="form-group">
                                ...
                                <div class="options weight" style="height: 0px; padding: 0;">
                                    ...
                                    <p onclick="selectOption(this)">8</p>
                            ...
                            <div class="form-group">
                                    <input type="text" class="form-control city_village_input" name="city_village" placeholder="Street" required="true">
                     ...
                     <div class="col-lg-4  col-md-12 col-sm-12">
                        <div class="details_category">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control district_input" name="district" placeholder="Baranggay" required="true">
                            ...
                            <div class="form-group">
                                    ...
                                    <p class="state_dummy dummy_dropdown" onclick="displayOptions(this,'.state_input','.state')">Select City or Municipality <span style="transform: translateY( -50% ) rotate(-90deg);">&#60;</span></p>

                                    <div class="options state" style="height: 0px; padding: 0;">
                                        <p onclick="selectOption(this)">Aliaga</p>
                                        <p onclick="selectOption(this)">Bongabon</p>
                                        <p onclick="selectOption(this)">Cabanatuan</p>
                                        <p onclick="selectOption(this)">Cabiao</p>
                                        <p onclick="selectOption(this)">Carranglan</p>
                                        <p onclick="selectOption(this)">Cuyapo</p>
                                        <p onclick="selectOption(this)">Gabaldon</p>
                                        <p onclick="selectOption(this)">Gapan</p>
                                        <p onclick="selectOption(this)">General Mamerto Natividad</p>
                                        <p onclick="selectOption(this)">General Tinio</p>
                                        <p onclick="selectOption(this)">Guimba</p>
                                        <p onclick="selectOption(this)">Jaen</p>
                                        <p onclick="selectOption(this)">Laur</p>
                                        <p onclick="selectOption(this)">Licab</p>
                                        <p onclick="selectOption(this)">Llanera</p>
                                        <p onclick="selectOption(this)">Lupao</p>
                                        <p onclick="selectOption(this)">Nampicuan</p>
                                        <p onclick="selectOption(this)">Palayan</p>
                                        <p onclick="selectOption(this)">Pantabangan</p>
                                        <p onclick="selectOption(this)">Penaranda</p>
                                        <p onclick="selectOption(this)">Quezon (NE)</p>
                                        <p onclick="selectOption(this)">Rizal (NE)</p>
                                        <p onclick="selectOption(this)">San Antonio (NE)</p>
                                        <p onclick="selectOption(this)">San Isidro (NE)</p>
                                        <p onclick="selectOption(this)">San Jose (NE)</p>
                                        <p onclick="selectOption(this)">San Leonardo</p>
                                        <p onclick="selectOption(this)">Santa Rosa (NE)</p>
                                        <p onclick="selectOption(this)">Santo Domingo (NE)</p>
                                        <p onclick="selectOption(this)">Science City of Munoz</p>
                                        <p onclick="selectOption(this)">Talavera</p>
                                        <p onclick="selectOption(this)">Talugtug</p>
                                        <p onclick="selectOption(this)">Zaragoza</p>
                            ...
                            <div class="form-group">
                                <label for="description" style="color:#b6b6b6;padding-left: 18px;opacity: 0.8;"><span style="color: #F9575C; font-size: 12px; font-weight: 100;"> Description</span></label>
                                <textarea  class="description_input" style="width:100%; height: 140px;"  name="description" placeholder="Make it short and sweet" required="true"></textarea>
