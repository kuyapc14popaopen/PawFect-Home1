...
//post ad start
var breed = [['Siamese','Persian','Maine Coons','Ragdoll','Bengals','Abyssinian','Birmans', 'Sphynx', 'Scottish Fold', 'Russian Blue'],['Labrador Retrievers','German Shepherds','Golden Retrievers','French Bulldogs','Bulldogs','Beagles','Poodles','Rottweilers', 'Rottweilers', 'Dachshund', 'Siberian Husky'],['Betta','Goldfish','Angelfish','Catfish','Guppies', 'Tetras', 'Mollies', 'Cichlids', 'Oscars', 'Swordtails']];
var reloadHTML;
